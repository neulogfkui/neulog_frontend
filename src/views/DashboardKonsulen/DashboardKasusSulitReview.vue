<template>
	...
	<div class="container mt-4">
        ...
        <div v-if="dataTableReady" class="container mt-5">
            ...
            <div class="card-header">Pembahasan Kasus Sulit (Review)</div>
                <div class="card-body">
                    <div class="datatable">
                        <table
...
export default {
    ...
    created() {
        axios
            .get("https://neulogfkui.herokuapp.com/api/laporantugas/kasus-sulit/review/"+JSON.parse(localStorage.getItem("userData")).konsulen.idKonsulen, { headers: authHeader() })
            .then(success => {
