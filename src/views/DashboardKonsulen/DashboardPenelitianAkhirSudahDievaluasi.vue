...
export default {
    ...
    created() {
        axios
            .get("http://localhost:8000/api/laporantugas/penelitian-akhir/sudah-dievaluasi/"+JSON.parse(localStorage.getItem("userData")).konsulen.idKonsulen, { headers: authHeader() })
            .then(success => {
