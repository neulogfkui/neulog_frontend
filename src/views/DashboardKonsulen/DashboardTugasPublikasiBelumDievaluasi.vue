<template>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        <h1 class="page-header-title">
                            ...
                            Dashboard Konsulen | Tugas Publikasi
                        </h1>
	...
	<div class="container mt-4">
        ...
        <nav class="nav nav-borders">
            <router-link class="nav-link active ml-0" to="/dashboard-konsulen/tugas-publikasi/belum-dievaluasi">Belum Dievaluasi</router-link>
		    <router-link class="nav-link" to="/dashboard-konsulen/tugas-publikasi/sudah-dievaluasi">Sudah Dievaluasi</router-link>
            <router-link class="nav-link" to="/dashboard-konsulen/tugas-publikasi/review">Review</router-link>
        </nav>
        ...
        <div v-if="dataTableReady" class="container mt-5">
            ...
            <div class="card-header">Tugas Publikasi (Belum Dievaluasi)</div>
                <div class="card-body">
                    <div class="datatable">
                        <table
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                <td>{{ laporan.judulPublikasi }}</td>
                                <td>{{ laporan.eventPublikasi }}</td>
...
export default {
    ...
    created() {
        axios
            .get("https://neulogfkui.herokuapp.com/api/laporantugas/tugas-publikasi/belum-dievaluasi/"+JSON.parse(localStorage.getItem("userData")).konsulen.idKonsulen, { headers: authHeader() })
            .then(success => {
    ...
    methods: {
		redirectToView(idLaporan) {
            this.$router.push('/tugaspublikasidetail/'+idLaporan);
