...
export default {
    ...
    created() {
        axios
            .get("http://localhost:8000/api/laporantugas/tugaspresentasi/belum-dievaluasi/"+JSON.parse(localStorage.getItem("userData")).konsulen.idKonsulen, { headers: authHeader() })
            .then(success => {
