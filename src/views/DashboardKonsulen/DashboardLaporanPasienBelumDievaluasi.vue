...
export default {
    ...
    created() {
        axios
            .get("https://neulogfkui.herokuapp.com/api/laporan-pasien/belum-dievaluasi/"+JSON.parse(localStorage.getItem("userData")).konsulen.idKonsulen, { headers: authHeader() })
            .then(success => {
