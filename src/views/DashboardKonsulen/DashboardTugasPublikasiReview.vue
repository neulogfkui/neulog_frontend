<template>
	...
	<div class="container mt-4">
        ...
        <nav class="nav nav-borders">
            ...
            <router-link class="nav-link active ml-0" to="/dashboard-konsulen/tugas-publikasi/review">Review</router-link>
        </nav>
        ...
        <div v-if="dataTableReady" class="container mt-5">
            ...
            <div class="card-header">Tugas Publikasi (Review)</div>
                <div class="card-body">
                    <div class="datatable">
                        <table
...
export default {
    ...
    created() {
        axios
            .get("https://neulogfkui.herokuapp.com/api/laporantugas/tugas-publikasi/review/"+JSON.parse(localStorage.getItem("userData")).konsulen.idKonsulen, { headers: authHeader() })
            .then(success => {
