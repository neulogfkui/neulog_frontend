<template>
	...
	<div class="container mt-4">
        ...
        <nav class="nav nav-borders">
            <router-link class="nav-link" to="/dashboard-konsulen/tugas-publikasi/belum-dievaluasi">Belum Dievaluasi</router-link>
		    <router-link class="nav-link active ml-0" to="/dashboard-konsulen/tugas-publikasi/sudah-dievaluasi">Sudah Dievaluasi</router-link>
        ...
        <div v-if="dataTableReady" class="container mt-5">
            ...
            <div class="card-header">Tugas Publikasi (Sudah Dievaluasi)</div>
                <div class="card-body">
                    <div class="datatable">
                        <table
...
export default {
    ...
    created() {
        axios
            .get("http://localhost:8080/api/laporantugas/tugas-publikasi/sudah-dievaluasi/"+JSON.parse(localStorage.getItem("userData")).konsulen.idKonsulen, { headers: authHeader() })
            .then(success => {
