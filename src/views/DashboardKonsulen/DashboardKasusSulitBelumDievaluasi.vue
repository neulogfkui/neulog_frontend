<template>
	...
	<div class="container mt-4">
        ...
        <nav class="nav nav-borders">
            <router-link class="nav-link active ml-0" to="/dashboard-konsulen/kasus-sulit/belum-dievaluasi">Belum Dievaluasi</router-link>
        ...
        <div v-if="dataTableReady" class="container mt-5">
            ...
            <div class="card-header">Pembahasan Kasus Sulit (Belum Dievaluasi)</div>
                <div class="card-body">
                    <div class="datatable">
                        <table
...
export default {
    ...
    created() {
        axios
            .get("https://neulogfkui.herokuapp.com/api/laporantugas/kasus-sulit/belum-dievaluasi/"+JSON.parse(localStorage.getItem("userData")).konsulen.idKonsulen, { headers: authHeader() })
            .then(success => {
    ...
    methods: {
		redirectToView(idLaporan) {
            this.$router.push('/kasussulitdetail/'+idLaporan);
