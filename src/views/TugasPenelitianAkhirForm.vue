    ...
    if (this.$route.params.operation != 0) {
      axios
        ...
        .then((resp) => {
          ...
          this.posts.judulProposal = resp.data.tugas.tugasPenelitianAkhirModel.judulProposal;
          ...
          this.posts.idChild = resp.data.tugas.tugasPenelitianAkhirModel.idTugasPenelitianAkhir;
