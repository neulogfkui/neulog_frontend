<template>
  ...
  <div class="container upper" v-if="isReady">
	...
	<nav class="nav nav-borders">
		<router-link class="nav-link " to="/dashboard-ketua-modul/belum-lulus">Belum Lulus</router-link>
		<router-link class="nav-link active ml-0" to="/dashboard-ketua-modul/sudah-lulus">Sudah Lulus</router-link>
	</nav>
        ...
        <div class="card-body">
          <div class="datatable" v-if="isReady">
            ...
            >
              ...
              <tbody>
                <tr
                  v-for="(item, index) in this.data.listResidenLulus"
