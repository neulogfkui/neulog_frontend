...
export default {
  ...
  methods: {
    ...
    postData(e) {
      ...
      if (this.$route.params.operation != 0) {
        url = "http://localhost:8080/api/laporan-pasien/update";
      } else {
        url = "http://localhost:8080/api/laporan-pasien/create";
      }
  ...
  mounted() {
    ...
    axios
      .get("http://localhost:8080/api/laporan-pasien/getformattribute")
      .then((resp) => {
