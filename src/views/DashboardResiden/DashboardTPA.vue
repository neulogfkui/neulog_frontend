<template>
  ...
  <div class="container">
    <div class="row upper justify-content-center">
      <PieChart
        v-if="isMounted"
        keterangan="Laporan Tugas Penelitian Akhir"
        :persentase="this.persentase"
        :total="this.total"
        :label="this.label"
        :data="this.jumlah"
        title="Sebaran Status Laporan Tugas Penelitian Akhir"
      />
      <!-- Tabel -->
      <div class="col-xxl-12 col-xl-12 mb-4 mt-4">
        <div class="card card-header-actions h-100">
          <div class="card-header">
            <b>Daftar Laporan Tugas Penelitian Akhir</b>
          </div>
          <div class="card-body">
            <div class="datatable" v-if="isDataTableReady">
              ...
              >
                ...
                <tbody>
                  ...
                  >
                    <td>{{ index + 1 }}</td>
                    <td>{{ item.laporanTugasPenelitianAkhirModel.LaporanTugasModel.tanggalDibuat }}</td>
                    <td>{{ item.judulProposal }}</td>
                    <td>{{ item.stage }}</td>
                    <td>{{ item.konsulen.penggunaModel.name }}</td>
                    <td>{{ item.laporanTugasPenelitianAkhirModel.LaporanTugasModel.status }}</td>
                    <td>
                      <!-- <router-link
      ...
      (function (factory) {
                  ...
                  if (col.mData === i) {
                    ...
                    if (sort !== null || filter !== null) {
                      col.mData = {
                        ...
                        filter:
                          filter !== null ? i + ".@data-" + filter : undefined,
                      };
        ...
        _api_register("cells()", function (rowSelector, columnSelector, opts) {
          ...
          var internalOpts = opts
            ? { page: opts.page, order: opts.order, search: opts.search }
            : {};
