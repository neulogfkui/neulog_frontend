<template>
  ...
  <div class="container">
    <div class="row upper justify-content-center">
      <PieChart
        v-if="isMounted"
        keterangan="Laporan Tugas Publikasi"
        :persentase="this.persentase"
        :total="this.total"
        :label="this.label"
        :data="this.jumlah"
        title="Sebaran Status Laporan Tugas Publikasi"
      />
      <!-- Tabel -->
...
export default {
  ...
  mounted() {
    axios
      .get("http://localhost:8000/api/dashboardResiden/laporanTugas/tugasPublikasi/" + this.$route.params.idResiden)
      .then((resp) => {
