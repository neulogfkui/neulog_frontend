              ...
              >
                ...
                <tbody>
                  <tr v-for="(item, index) in listTugas" v-bind:key="item.id">
                    ...
                    <td>
                      <router-link
                        :to="'/detailtugas/tugasPublikasi/' + item.idLaporanTugas"
                      >
...
export default {
  ...
  mounted() {
    axios
      .get(
        "http://localhost:8000/api/dashboardResiden/laporanTugas/tugasPublikasi/" +
